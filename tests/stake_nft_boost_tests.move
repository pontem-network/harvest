...
module harvest::stake_nft_boost_tests {
    ...
    public fun test_boost_and_remove_boost() {
        ...
        stake::register_pool<StakeCoin, RewardCoin>(&harvest, reward_coins,
            duration, 0, option::some(boost_config), vector[]);
    ...
    public fun test_is_boostable() {
        ...
        let duration = 15768000;
        stake::register_pool<RewardCoin, StakeCoin>(&harvest, reward_coins,
    ...
    public fun test_create_boost_config_fails_if_colleciont_does_not_exist_1() {
        ...
        stake::register_pool<StakeCoin, RewardCoin>(&harvest, coin::zero<RewardCoin>(),
            12345, 0, option::some(boost_config), vector[]);
    }
    ...
    public fun test_stake_and_boost_two_accounts_in_time() {
        ...
        let nft = stake::remove_boost<StakeCoin, RewardCoin>(&bob_acc, @harvest);
    ...
    public fun test_stake_and_boost_two_accounts_and_unstake() {
        ...
        let stake_coins = stake::unstake<StakeCoin, RewardCoin>(&bob_acc, @harvest, 500000000);
