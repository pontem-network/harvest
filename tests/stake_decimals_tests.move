...
module harvest::stake_decimals_tests {
    ...
    public fun test_reward_calculation_decimals_s0_r0() {
        ...
        stake::register_pool<StakeCoin, RewardCoin>(&harvest_acc, reward_coins, duration);
        ...
        let (_, reward_per_sec, accum_reward, last_updated, _, _) =
        ...
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@harvest, @alice) == 38, 1);
        ...
        // 3023975 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@harvest, @alice) == 3023975, 1);
        ...
        // 3024020 RewardCoins
        assert!(stake::get_pending_user_rewards<StakeCoin, RewardCoin>(@harvest, @alice) == 3024020, 1);
